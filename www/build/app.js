...
/*	//Drop tables
   "DROP TABLE IF EXISTS Users;",
	...
	//Insert Users
	"INSERT INTO 'Users' ('Name') VALUES ('BLAH BLAH BLAH5');",
    ...
    function AppController($scope, $ionicPopover, $ionicPopup, $http) {
        ...
        $scope.openPopover = function ($event) {
			...
			$ionicPopup.alert({
				...
				template: 'I freaking love kibblebits thx for feeding me!!!',
...
(function () {
	...
	function HomeController($scope, $ionicPopup, Modals, Model) {
		...
		$scope.HelloWorld = function () {
			$ionicPopup.alert({
				title: 'Hello Im a Kibblebit',
				template: 'I freaking love kibblebits k',
     		cssClass: 'animated bounceInDown'
			});
		};
...
'use strict';
    ...
    ItemController.$inject = ['$scope', '$stateParams', '$ionicViewSwitcher', '$state', '$ionicHistory', '$ionicPopup', 'Modals', 'Model'];
    function ItemController($scope, $stateParams, $ionicViewSwitcher, $state, $ionicHistory, $ionicPopup,Modals, Model) {
        ...
        $scope.item = {
            ...
            color: $stateParams.color
        		...
        		$scope.HelloWorld2 = function () {
			$ionicPopup.alert({
				title: 'Hello Im a Kibblebit',
				template: 'I freaking love kibblebits',
     		cssClass: 'animated bounceInDown'
			});
		};
